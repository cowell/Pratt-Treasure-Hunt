# Pratt Treasure Hunt (self-hosted backend)

This repository now provides a self-hosted FastAPI backend for a prize-driven treasure hunt app. Players join hunts, solve clues, and submit answers to climb leaderboards. You control rewards and hosting so you’re not locked into third-party platforms—perfect for running $1 downtown hunts in places like Pratt, KS.
